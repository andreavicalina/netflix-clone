  ...
  <div class="container-fluid">
    ...
    <div class="back-image">
      <main class="contenedor">
        <h1>Enola Holmes</h1>
        <p class="descripccion">While searching for her missing mother, intrepid teen Enola Holmes uses her sleuthing skills to outsmart big brother Sherlock and help a runaway lord.
        </p>
        <button role="button" class="boton"><i class="fas fa-play"></i>Tonton Sekarang</button>
        <button role="button" class="boton"><i class="fas fa-info-circle"></i>Lihat Selengkapnya</button>
      </main>
    </div>
