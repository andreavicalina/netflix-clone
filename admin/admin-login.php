            ...
            <div class="col-md-4 col-sm4 col-xs-12">     
              <?php
                ...
                if (isset($_POST['btn-login'])) {
                  ...
                  $sql = "SELECT * FROM admin WHERE nama_adm = '$nama_adm' AND pass_adm = '$pass_adm'";
              ...
              <form class="form-container needs-validation" method="post" novalidate>              
                <h1 class="text-center pb-4"><b>Admin</b></h1>
                ...
                <button type="submit" class="btn btn-danger btn-block mb-4" name="btn-login">Masuk</button>
