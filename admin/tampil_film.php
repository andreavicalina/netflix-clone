		...
		<table id="myTable" class="table">
			...
			<tbody>		
				<tr>
					...
					<td>
            			<a class="text-white badge bg-info" href="edit_film.php?id=<?php echo $pecah['id_film']; ?>">edit</a>
            			<a class="text-white badge bg-danger" href="hapus_film.php?id=<?php echo $pecah['id_film'];?>" onclick="return confirm('Apakah yakin ingin menghapus?')">hapus</a>
					</td>
				</tr>
			</tbody>
			<?php $no++; ?>
