...
<div class="">
    ...
    <div class="container mt-3">
        <div class="bg-card w-75 mb-5">
            <div class="card-header"><strong><h4>Tambah TV series Baru</h4></strong></div>
        </div>
    	<form action="upl_srsQuery.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-6">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Judul tv series</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="jdl_srs" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Tahun Rilis</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="thn_srs" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Cover</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="file" name="cover_srs" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="alur_srs" required>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="pemeran_srs" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Deskripsi</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="desc_srs" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Trailer</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="link" name="trailer_srs">
                        </div>
                    </div>
