...
<div class="">
    ...
    <div class="container mt-3">
        <div class="bg-card w-75 mb-5">
            <div class="card-header"><strong><h4>Tambah Film Baru</h4></strong></div>
        </div>
    	<form action="upl_filmQuery.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-6">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Judul Film</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="jdl_film" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Tahun Rilis</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="thn_rilis" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Cover</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="file" name="cover_film" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 aa">
                            <select class="form-control" name="bts_usia" required>
                                <option hidden>Pilih Batas Usia</option>
                                    <?php
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="alur_film" required>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="pemeran_film" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Durasi</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="durasi_film" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Deskripsi</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="desc_film" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Trailer</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="link" name="trailer_film">
                        </div>
                    </div>
